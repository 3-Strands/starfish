...
class SyncWebRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SyncWebRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'sil.starfish'), createEmptyInstance: create)
    ..pc<SyncRequest>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestData', $pb.PbFieldType.PM, subBuilder: SyncRequest.create)
    ..hasRequiredFields = false
  ;
  ...
  factory SyncWebRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SyncWebRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SyncWebRequest copyWith(void Function(SyncWebRequest) updates) => super.copyWith((message) => updates(message as SyncWebRequest)) as SyncWebRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SyncWebRequest create() => SyncWebRequest._();
  SyncWebRequest createEmptyInstance() => create();
  static $pb.PbList<SyncWebRequest> createRepeated() => $pb.PbList<SyncWebRequest>();
  @$core.pragma('dart2js:noInline')
  static SyncWebRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SyncWebRequest>(create);
...
class SyncWebResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SyncWebResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'sil.starfish'), createEmptyInstance: create)
    ..pc<SyncResponse>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'responseData', $pb.PbFieldType.PM, subBuilder: SyncResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  factory SyncWebResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SyncWebResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SyncWebResponse copyWith(void Function(SyncWebResponse) updates) => super.copyWith((message) => updates(message as SyncWebResponse)) as SyncWebResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SyncWebResponse create() => SyncWebResponse._();
  SyncWebResponse createEmptyInstance() => create();
  static $pb.PbList<SyncWebResponse> createRepeated() => $pb.PbList<SyncWebResponse>();
  @$core.pragma('dart2js:noInline')
  static SyncWebResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SyncWebResponse>(create);
