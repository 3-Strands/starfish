                  ...
                  child: BlocBuilder<OtpBloc, OtpState>(
                    builder: (context, state) {
                      return PinCodeTextField(
                        ...
                        onChanged: (value) =>
                          BlocProvider.of<OtpBloc>(context).add(OtpEvent(value)),
                        onSubmitted: state.isComplete
                          ? (_) => BlocProvider.of<SessionBloc>(context).add(SMSCodeEntered(state.code))
                          : null,
                      );
                    },
                  ),
                ...
                child: Container(
                  ...
                  child: BlocBuilder<OtpTimerBloc, OtpTimerState>(
                    builder: (context, state) {
                      ...
                      return TextButton(
                        onPressed: () {
                          BlocProvider.of<SessionBloc>(context).add(const SMSCodeRefreshRequested());
                        },
                        child: Text(
                    ...
                    builder: (context, state) {
                      ...
                      return ElevatedButton(
                        ...
                        onPressed: state.isComplete
                          ? () => sessionBloc.add(SMSCodeEntered(state.code))
                          : null,
                        style: ElevatedButton.styleFrom(
                          primary:
