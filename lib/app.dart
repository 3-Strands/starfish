...
import 'package:starfish/authenticated_app.dart';
...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => AppBloc(localStorageApi: localStorageApi)),
        BlocProvider(create: (_) => SessionBloc(
          sessionRepository: sessionRepository,
          initialState: session != null ? SessionActive(session) : const SessionInactive(),
        )),
      ],
      child: const AppView(),
    );
